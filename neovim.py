...
def make_doc(src):
    ...
    os.system(f'cd {doc_path} && make html')
    
    # Creating docset directory
    print('Creating docset directory...')
    docset_path = 'Neovim.docset'
    docset_content_path = os.path.join(doc_path, 'Contents')
    ...
    # Making ICON
    print('Making ICON...')
    with open(os.path.join(docset_path, 'icon.png'), 'wb') as f:
        f.write(base64.b64decode(resources['icon']))
    with open(os.path.join(docset_path, 'icon@2x.png'), 'wb') as f:
